...
export function Sidebar() {
  ...
  const { isOpen, isCollapsed, setIsOpen, toggleCollapsed, isMobile } = useSidebar();
  ...
  const sidebarContent = (
    <aside
      className={cn(
        ...
        sidebarWidth,
        // On mobile: off-screen by default, slides in when open
    ...
    >
      ...
      <nav className="flex-1 px-3 py-4 space-y-0.5 overflow-y-auto" aria-label="Primary">
        ...
        <div className="pt-4 mt-4 border-t border-border/60">
          <div className={cn('flex items-center gap-2 px-3 mb-2', isCollapsed && !isMobile && 'justify-center px-2')}>
      ...
      {/* Theme Toggle + User */}
      <div className="px-3 py-3 border-t border-border/60">
        <div className={cn('flex items-center gap-3', isCollapsed && !isMobile && 'flex-col gap-2')}>
          ...
          <div className={cn('flex', isCollapsed && !isMobile ? 'flex-col gap-1' : 'flex-row gap-0')}>
            <button
              onClick={toggleTheme}
