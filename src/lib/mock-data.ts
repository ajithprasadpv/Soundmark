...
export const mockAdminUsers: AdminUserProfile[] = [
  {
    ...
    nextRenewal: '2026-03-12T00:00:00Z',
    paymentMethod: 'card',
    venueCount: 8,
    deviceCount: 12,
    totalPlayHours: 4820,
  ...
  },
  {
    ...
    billingAmount: 49,
    billingCycle: 'monthly',
    nextRenewal: '2026-03-20T00:00:00Z',
    paymentMethod: 'card',
    venueCount: 4,
    deviceCount: 4,
    totalPlayHours: 1560,
  ...
  },
  {
    ...
    billingAmount: 1499,
    billingCycle: 'yearly',
    nextRenewal: '2026-11-01T00:00:00Z',
    paymentMethod: 'card',
    venueCount: 11,
    deviceCount: 22,
    totalPlayHours: 6300,
  ...
  },
  {
    ...
    billingAmount: 49,
    billingCycle: 'monthly',
    nextRenewal: '2026-03-15T00:00:00Z',
    paymentMethod: 'card',
    trialEndsAt: '2026-02-28T23:59:59Z',
    venueCount: 2,
    deviceCount: 3,
    totalPlayHours: 180,
  ...
  },
  {
    id: '10',
    name: 'Carlos Mendez',
    email: 'carlos@ritzcollection.mx',
    phone: '+52 55 1234 5678',
    role: 'owner',
    status: 'active',
    organizationId: '8',
    organizationName: 'Ritz Collection Mexico',
    planType: 'enterprise',
    subscriptionStatus: 'active',
    billingAmount: 4999,
    billingCycle: 'yearly',
    nextRenewal: '2026-06-01T00:00:00Z',
    paymentMethod: 'invoice',
    venueCount: 28,
    deviceCount: 56,
    totalPlayHours: 18500,
  ...
  },
  {
    ...
    billingAmount: 149,
    billingCycle: 'monthly',
    nextRenewal: '2026-03-05T00:00:00Z',
    paymentMethod: 'card',
    venueCount: 15,
    deviceCount: 30,
    totalPlayHours: 7800,
  ...
  },
  {
    id: '12',
    name: 'Liam O\'Brien',
    email: 'liam@brewhaus.de',
    phone: '+49 30 1234 5678',
    role: 'owner',
    status: 'active',
    organizationId: '10',
    organizationName: 'BrewHaus Berlin',
    planType: 'starter',
    subscriptionStatus: 'trial',
    billingAmount: 49,
    billingCycle: 'monthly',
    nextRenewal: '2026-03-10T00:00:00Z',
    paymentMethod: 'card',
    trialEndsAt: '2026-03-01T23:59:59Z',
    venueCount: 3,
    deviceCount: 3,
    totalPlayHours: 95,
    createdAt: '2026-02-01T10:00:00Z',
    lastActive: '2026-02-12T10:20:00Z',
  },
];
...
function generateProofOfPlayData(): MonthlyReport[] {
  ...
  const artists = ['Soundmark Studio', 'Clara Voss', 'Nova Beats', 'Marcus Bell', 'Luana Ferreira', 'The Meadows', 'Owen Hartley', 'Nordic Sound Lab', 'Synthwave Collective', 'Deep Frequency', 'Elise Laurent'];
